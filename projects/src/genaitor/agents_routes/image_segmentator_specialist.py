...
SYSTEM_MESSAGE = "I am an AI agent specialized in image segmentation using Python and OpenCV. I will receive an image array and return the segmented image based on your requirements.'"
